...
pr_rcp_co_all = list.files(path = pr_path,pattern = "^pr_co_pr.rcp85")
...
pr_rcp_co = readRDS(file = paste0(pr_path,pr_rcp_co_all[1]))
...
# co_data = list(gls.tas.summary = gls.tas.summary,
#                gls.tas.rcp = gls.tas.rcp,
#                gls.pr.summary = gls.pr.summary,
#                gls.pr.rcp = gls.pr.rcp,
#                co_elevation = co_elevation)
# save(co_data, file = "/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/co_data.rdata")
...
gwgr.pre.co = list(res.gr = res.gr,
                   res.gwgr = res.gwgr,
                   future.gwgr = future.gwgr
                   #gwgr.AICc.lm = gwgr.AICc
                   )
#save(gwgr.pre.co,file = "/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/co_pre_coef.rdata")
