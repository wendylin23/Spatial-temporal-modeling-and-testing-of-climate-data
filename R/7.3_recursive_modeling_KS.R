...
gls.tas.all = rbind(gls.tas.summary,gls.tas.rcp)## spatial seasonal trend
...
## Historical
load("/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/ks_tas_coef.rdata")
...
w_beta_est = t(ks_tas_coef$ks_tas_w$coef[2,,])
w_beta_se = t(ks_tas_coef$ks_tas_w$se.coef[2,,])
w_sea_coef = cbind(c(ks_tas_coef$ks_tas_w$coef[4,1,]),
                   c(ks_tas_coef$ks_tas_w$coef[5,2,]),
                   c(ks_tas_coef$ks_tas_w$coef[6,3,]),
                   c(ks_tas_coef$ks_tas_w$coef[7,4,]))
w_sea_se = cbind(c(ks_tas_coef$ks_tas_w$se.coef[4,1,]),
                   c(ks_tas_coef$ks_tas_w$se.coef[5,2,]),
                   c(ks_tas_coef$ks_tas_w$se.coef[6,3,]),
                   c(ks_tas_coef$ks_tas_w$se.coef[7,4,]))
w_resids = ks_tas_coef$ks_tas_w$residuals
for(i in 1:n.loc)
{
...
w_rcp_beta_est = t(ks_tas_coef$ks_tas_pre$coef[2,,])
w_rcp_beta_se = t(ks_tas_coef$ks_tas_pre$se.coef[2,,])
w_rcp_sea_coef = cbind(c(ks_tas_coef$ks_tas_pre$coef[4,1,]),
                   c(ks_tas_coef$ks_tas_pre$coef[5,2,]),
                   c(ks_tas_coef$ks_tas_pre$coef[6,3,]),
                   c(ks_tas_coef$ks_tas_pre$coef[7,4,]))
w_rcp_sea_se = cbind(c(ks_tas_coef$ks_tas_pre$se.coef[4,1,]),
                 c(ks_tas_coef$ks_tas_pre$se.coef[5,2,]),
                 c(ks_tas_coef$ks_tas_pre$se.coef[6,3,]),
                 c(ks_tas_coef$ks_tas_pre$se.coef[7,4,]))
w_rcp_resids = ks_tas_coef$ks_tas_pre$residuals
for(i in 1:n.loc)
{
...
save(slope_new, file =  "/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/ks_slope_v_new.rdata")
