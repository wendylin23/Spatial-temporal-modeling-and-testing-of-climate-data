...
## Historical
load("/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/co_tas_coef.rdata")
...
w_beta_est = t(co_tas_coef$co_tas_w$coef[2,,])
w_beta_se = t(co_tas_coef$co_tas_w$se.coef[2,,])
w_sea_coef = cbind(c(co_tas_coef$co_tas_w$coef[4,1,]),
                   c(co_tas_coef$co_tas_w$coef[5,2,]),
                   c(co_tas_coef$co_tas_w$coef[6,3,]),
                   c(co_tas_coef$co_tas_w$coef[7,4,]))
w_sea_se = cbind(c(co_tas_coef$co_tas_w$se.coef[4,1,]),
                   c(co_tas_coef$co_tas_w$se.coef[5,2,]),
                   c(co_tas_coef$co_tas_w$se.coef[6,3,]),
                   c(co_tas_coef$co_tas_w$se.coef[7,4,]))
w_resids = co_tas_coef$co_tas_w$residuals
for(i in 1:n.loc)
{
...
w_rcp_beta_est = t(co_tas_coef$co_tas_pre$coef[2,,])
w_rcp_beta_se = t(co_tas_coef$co_tas_pre$coef[2,,])
w_rcp_sea_coef = cbind(c(co_tas_coef$co_tas_pre$coef[4,1,]),
                   c(co_tas_coef$co_tas_pre$coef[5,2,]),
                   c(co_tas_coef$co_tas_pre$coef[6,3,]),
                   c(co_tas_coef$co_tas_pre$coef[7,4,]))
w_rcp_sea_se = cbind(c(co_tas_coef$co_tas_pre$se.coef[4,1,]),
                 c(co_tas_coef$co_tas_pre$se.coef[5,2,]),
                 c(co_tas_coef$co_tas_pre$se.coef[6,3,]),
                 c(co_tas_coef$co_tas_pre$se.coef[7,4,]))
w_rcp_resids = co_tas_coef$co_tas_pre$residuals
for(i in 1:n.loc)
{
...
save(slope_new, file =  "/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/co_slope_v_new.rdata")
