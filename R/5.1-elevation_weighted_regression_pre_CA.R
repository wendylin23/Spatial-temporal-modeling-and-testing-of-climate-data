...
#pr_rcp45_ca_all = list.files(path = pr_path,pattern = "^pr_ca_pr.rcp45")
...
# save(ca_data, file = "/Users/wenyilin/Dropbox/UCSD/Thesis/3.Precipitation/Code/results/summary_results_20211101/ca_data.rdata")
